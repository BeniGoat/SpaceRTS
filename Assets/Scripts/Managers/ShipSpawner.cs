...
namespace SpaceRTS.Managers
{
    ...
    public class ShipSpawner : MonoBehaviour
    {
        ...
        private void TrySpawnShipAtSelection()
        {
            ...
            // Check if the selected SystemBody has a ShipFactory
            ShipFactory shipFactory = selectedBody.ShipFactory;
            if (shipFactory == null)
                return;
        ...
        private SystemBody GetSystemBodyFromSelection(ISelectable selectable)
        {
            ...
            if (selectable is not SelectableComponent selectableComponent)
                return null;

            // Check if the selectable's GameObject has a SystemBody component
            ...
            // If neither a SystemBody nor a Ship with a CurrentSystemBody was found, return null
            return null;
        }
    }
}